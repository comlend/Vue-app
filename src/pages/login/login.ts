...
export class LoginPage {
	...
	constructor(public navCtrl: NavController, public navParams: NavParams, private firebase: FirebaseProvider, public globals: GlobalsProvider, public formBuilder: FormBuilder, public loadingCtrl: LoadingController) {
		this.initializeForm()
	}
